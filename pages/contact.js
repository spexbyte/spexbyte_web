      ...
      <div className="xl:w-sw ">
        <div className="">
          ...
          <p className="font-light text-lg xl:text-2xl xl:w-2/4">
            ...
            Akwaaba! We are excited to learn more about your project and how we
            can help. Please take a moment to fill out the form below and tell
            us about your project. We will be in touch shortly to discuss how we
